...
public class tempMenuBar9 extends JFrame implements ActionListener{
...
if (e.getActionCommand() == "New") message = "The New Item was selected";
else if (e.getActionCommand() == "Open") message = "The Open Item was selected";
