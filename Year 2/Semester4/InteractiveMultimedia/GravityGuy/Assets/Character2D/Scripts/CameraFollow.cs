...
public class CameraFollow : MonoBehaviour 
{
	...
	public Vector2 maxXAndY = new Vector2(5f, 5f);		// The maximum x and y coordinates the camera can have.
	public Vector2 minXAndY = new Vector2(-5f, -5f);		// The minimum x and y coordinates the camera can have.
