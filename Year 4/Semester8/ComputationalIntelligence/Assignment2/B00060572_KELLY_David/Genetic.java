...
public class Genetic {
	...
	private static final float MUTATION_FRACTION = .1f; // 10% of populaiton is mutated
	private static final int NUM_GENERATIONS = 2000; // Max number of generations to run for
	...
	public static void main(String[] args) {
		...
		// Run the genetic algorithm over NUM_GENERATIONS or until it has
