...
public class BugReport {
	...
	private static String getRelevantLogContent() {
		...
		try {
			List<String> logLineList = new LinkedList<String>();
	...
	public static void createBugZillaReport(XmlRpcClient client, Throwable exception, String userSummary,
	                                        ...
	                                        String os, File[] attachments, boolean attachProcess, boolean attachSystemProps, boolean attachLogFile) throws Exception {
...
//        	attachmentMap.put("data", Base64.encodeFromFile(file.getPath()));
	 ...
	 */
	public static String createCompleteBugDescription(String userDescription, Throwable exception, boolean attachProcess, boolean attachSystemProps, boolean attachLog) {
		StringBuffer buffer = new StringBuffer();
