...
in the 'licenses' directory of RapidMiner. These libraries are
  ...
  lib/jama.jar  
  		...
  		JAMA is a basic linear algebra package for Java. This 
  ...
  lib/jep.jar Used for expression parsing
  ...
  lib/encog.jar  A library for neural network learning. This library is
                 changed from the original by introducing the usage of 
                 fixed random numbers and some other small modifications.
  
                 Current Version: own based on 1.1                 
  ...
  lib/looks.jar  This library contains one of the look and feels of 
                 RapidMiner. More information at http://www.jgoodies.com
  
                 Current Version: 2.1.4
                 
  lib/jh.jar   This library contains the Java Help system. More 
  ...
  lib/rome.jar  This library is used for reading RSS / Atom feeds
  
                 Current Version: 1.0
                 
  lib/jdom.jar  This library is used for supporting ROME.
  
                 Current Version: ?
                 
  lib/groovy-all.jar  This library is used for supporting Groovy scripting.
